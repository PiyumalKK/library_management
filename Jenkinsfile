        ...
        script {
            if (isUnix()) {
                sh '''
                    ...
                    echo "Step 7: Restarting deployments..."
                    kubectl rollout restart deployment mysql-deployment
                    kubectl rollout restart deployment my-app-deployment
                    ...
                    echo "Step 10: Inspecting deployment for restartedAt annotation..."
                    kubectl get deployment mysql-deployment -o yaml | grep restartedAt

                    # SECOND DEPLOYMENT ATTEMPT
                    echo "Running second deployment attempt..."
                    
                    echo "Applying deployment YAML again..."
                    kubectl apply -f kubernetes/deployment.yml

                    echo "Restarting deployments again..."
                    kubectl rollout restart deployment mysql-deployment
                    kubectl rollout restart deployment my-app-deployment
